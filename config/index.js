export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx0b1fad7d7f8d133a",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1aca3f7e7762a775bc53599baac8c9e5",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "最最最亲爱的老婆", "year": "2003", "date": "08-18"},
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2022-2-19"},
        // 恋爱纪念日
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "最最最亲爱的老婆", "year": "2003", "date": "08-18", isShowAge: true},
    {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "02-19"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
